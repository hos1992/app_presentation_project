...
<g>
    ...
    <path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" id="top-profile-tab" data-toggle="tab" href="#top-profile"
                                   role="tab" aria-controls="top-profile" aria-selected="true"><span
                                        class="icon-user mr-2"></span>&nbsp; بيانات الدخول</a>
                            </li>
                        </ul>
                                ...
                                <form action="{{ route('adminLogin') }}" method="post"
                                    ...
                                    <div class="form-group">
                                        <input  name="email" type="email" class="form-control"
                                               placeholder="البريد الالكترونى" id="exampleInputEmail1">
        ...
        <a href="/" class="btn btn-primary back-btn"><i data-feather="arrow-left"></i>رجوع</a>
    </div>
